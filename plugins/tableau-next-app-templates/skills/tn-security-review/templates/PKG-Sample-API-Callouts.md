# {{PACKAGE}} - Sample API Callouts

**Package**: {{PACKAGE}} (Managed 2GP), namespace `{{NAMESPACE}}`, `{{VERSION_ID}}`
...
grep -rn "resourceUrl" force-app/main/default/lwc   # 1: the import in {{LWC}}.js
